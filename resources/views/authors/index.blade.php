                    ...
                    <form action="{{ route('authors.index') }}" method="GET" class="flex items-center space-x-1">
                        <div class="relative">
                            <input type="text" name="search" placeholder="Search by name"
                                   ...
                                   class="border border-blue-500 px-4 py-2 rounded-md shadow-sm focus:ring-blue-400 focus:border-blue-400 transition duration-200 ease-in-out w-48 pl-10 text-lg" />
