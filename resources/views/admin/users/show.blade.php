    ...
    <div class="py-6 text-lg">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-xl sm:rounded-lg p-6 border border-blue-500">
                ...
                <div class="mb-4 text-gray-800 flex flex-col sm:flex-row items-center bg-blue-50 border-2 border-blue-500 rounded-lg shadow-lg p-6 w-full">
                    <div class="flex-shrink-0 mb-4 sm:mb-0">
                        <img src="{{ $user->profile_photo_url }}" 
                             alt="{{ $user->name }}" 
                             class="h-24 w-24 sm:h-28 sm:w-28 rounded-full object-cover border-2 border-blue-500">
                    </div>
                
                    <div class="flex flex-col sm:ml-4 w-full text-center sm:text-left">
                        ...
                        <p class="text-lg">
                            <strong>Role:</strong> {{ $user->roles->pluck('name')->implode(', ') }}
                        </p>
